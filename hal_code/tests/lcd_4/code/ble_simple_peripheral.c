...
void simple_peripheral_init(void)
{
    ...
    co_delay_100us(10*1000);
    plcd_dev->lcd_stitle(0,LCD_TYPE_BLE,1);
    
    co_delay_100us(10*1000);
    plcd_dev->lcd_stitle(0,LCD_TYPE_MUTE,1);


    co_delay_100us(10*1000);
    plcd_dev->lcd_stitle(0,LCD_TYPE_ALERT,1);

    for(int i=0;i<4;i++){        
        plcd_dev->lcd_sbattery(i*2*10);
        plcd_dev->lcd_stitle(i,LCD_TYPE_NUM,1);
        co_delay_100us(10*1000);
    }
    
    plcd_dev->lcd_stem(0,"123",strlen("123"),0);
    plcd_dev->lcd_stem(1,"456",strlen("456"),0);
    plcd_dev->lcd_stem(2,"789",strlen("789"),0);
    plcd_dev->lcd_stem(3,"444",strlen("444"),0);
